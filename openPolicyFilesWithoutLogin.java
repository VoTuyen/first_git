...
public class openPolicyFilesWithoutLogin {
    ...
    public static void validateHuongDanDatHangUrlWithoutLogin() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(driver.getCurrentUrl(),"https://staging.shopplay.vn/huong-dan-dat-hang");
    }
    ...
    public static void validateVanChuyenGiaoNhanUrlWithoutLogin() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(driver.getCurrentUrl(),"https://staging.shopplay.vn/chinh-sach-van-chuyen");
    }
    ...
    public static void validateBaoHanhVaChamSocKhachHangUrlWithoutLogin() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(driver.getCurrentUrl(),"https://staging.shopplay.vn/chinh-sach-bao-hanh");
    }
    ...
    public static void validateThanhToanHoanTienUrlWithoutLogin() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(driver.getCurrentUrl(),"https://staging.shopplay.vn/chinh-sach-thanh-toan");
    }
    ...
    public static void validateDieuKienGiaoDichChungUrlWithoutLogin() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(driver.getCurrentUrl(),"https://staging.shopplay.vn/dieu-kien-giao-dich-chung");
    }
    ...
    public static void validateChinhSachBaoMatThongTinUrlWithoutLogin() throws InterruptedException {
        ...
        Thread.sleep(1000);
        Assert.assertEquals(driver.getCurrentUrl(),"https://staging.shopplay.vn/bao-mat-thong-tin-ca-nhan");
    }
